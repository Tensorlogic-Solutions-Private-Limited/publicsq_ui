...
export async function POST({ params, request, cookies, fetch }) {
  try {
    ...
    const endpoint = `${PUBLIC_API_BASE_URL}/v1/exams/${id}/qn_papers/${qp_code}/questions`;
    ...
    if (contentType.includes("multipart/form-data")) {
      ...
      response = await fetch(`${PUBLIC_API_BASE_URL}/v1/exams/${id}/qn_papers/${qp_code}/images/question`, {
        method: "POST",
        headers: {
      ...
      response = await fetch(`${PUBLIC_API_BASE_URL}/v1/exams/${id}/qn_papers/${qp_code}/questions`, {
        method: "POST",
        headers: {
